...
local function requesturl(url, bypass) 
    ...
    local repourl = bypass and "https://raw.githubusercontent.com/IlIlIllIl/" or "https://raw.githubusercontent.com/IlIlIllIl/Future/main/"
...
local function getasset(path)
	if not isfile(path) then
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/IlIlIllIl/Future/main/"..path:gsub("Future/assets", "assets"),
			Method = "GET"
		})
